...
import nisumTask.helper.MinRangesHelper;
 ...
 * NOTES
 *
 * - The ranges above are just examples, your implementation should work for any
 * set of arbitrary ranges - Ranges may be provided in arbitrary order - Ranges
 * may or may not overlap - Your solution will be evaluated on the correctness
 * and the approach taken, and adherence to coding standards and best practices
 *
 * EXAMPLES
 *
 ...
 *
 * Your work will be evaluated against the following criteria: - Successful
 * implementation - Efficiency of the implementation - Design choices and
 * overall code organization - Code quality and best practices
 */
...
public class MinRangeFinder {
	...
	{
		List<ZipRange> inputRange = new ArrayList<ZipRange>();
		inputRange.add(new ZipRange(94133,94133));
		inputRange.add(new ZipRange(94200,94299));
		inputRange.add(new ZipRange(94226,94399));
		System.out.println("Input Zips: "+ inputRange);
		System.out.println("After Minimizing:  "+ MinRangesHelper.minRanges(inputRange));
	}	
